...
builder.Services.AddValidatorsFromAssemblyContaining<CreateRegistroGlicoseValidator>();


if (builder.Environment.IsDevelopment())
{
    var sqlitePath = Path.Combine(AppContext.BaseDirectory, "controle_glicemia.db");
